...
import hotstone.standard.hero.herobuilder.GammaStoneHeroBuilder;
...
public class GammaStoneFactory implements Factory {
    ...
    public HeroPower getHeroPower(Player player) {
        return new GammaStoneHeroBuilder().generateHeroPower(player);
    }
