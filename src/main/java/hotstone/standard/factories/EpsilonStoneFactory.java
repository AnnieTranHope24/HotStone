...
import hotstone.standard.hero.herobuilder.EpsilonStoneHeroBuilder;
...
public class EpsilonStoneFactory implements Factory {
    ...
    public HeroPower getHeroPower(Player player) {
        return new EpsilonStoneHeroBuilder().generateHeroPower(player);
    }
